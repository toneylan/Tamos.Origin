...
namespace Tamos.AbleOrigin.Booster
{
    internal class Log4netIntegration : ILogging
    {
        ...
        {
            //--Exceptionless
            var apiKey = ServiceAddressConfig.GetExternalSrvSet("CentralLog_ApiKey");
            if (apiKey.IsNull()) return;
            var serverUrl = ServiceAddressConfig.GetExternalSrvSet("CentralLog_ServerUrl", "http://host.docker.internal:5000");
        ...
        public Log4netIntegration(string name)
        {
